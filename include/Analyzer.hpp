...
/* IR Instruction - Energy Mapping Table */
#define ENERGY_INST_ALLOCA 	1
#define ENERGY_INST_STORE 	3
#define ENERGY_INST_LOAD 	2
#define ENERGY_INST_ADD 	3
#define ENERGY_INST_MUL 	4
#define ENERGY_INST_SDIV 	4
#define ENERGY_INST_RET 	1
#define ENERGY_INST_BR 		1
#define ENERGY_INST_ICMP 	2
...
public:
	BBNode(
			...
			unsigned int connectionType,
			unsigned int connectionNum)
		: eb(eb), node_id(node_id), connectionType(connectionType), connectionNum(connectionNum)
	{
		currentNum = 0;
